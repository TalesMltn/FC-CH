...
@section('content')
    <div class="card" style="background: var(--dark-light); border-radius: 15px; padding: 30px; box-shadow: 0 10px 30px rgba(0,0,0,0.5);">
        ...
        <div style="text-align: center; margin-top: 50px;">
            ...
            "
            onmouseover="this.style.background='var(--primary)'; this.style.color='white'; this.style.transform='translateY(-3px)';"
            onmouseout="this.style.background='rgba(255, 102, 0, 0.15)'; this.style.color='var(--primary)'; this.style.transform='translateY(0)';">
